...
# By Matt Favoino <mattfavoino@gmail.com>
#
...
def handle_launch():
    ...
    * Card title: 'alexa-midterm-election-brief
    * Card body: 'welcome_card'
    ...
    return question(welcome_text).reprompt(welcome_re_text).standard_card(title="alexa-midterm-election-brief",
